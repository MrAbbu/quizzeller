...
?>
<?php
if (@$_GET['q'] == 'quiz' && @$_GET['step'] == 2 && isset($_GET['endquiz'])== 'end') {
...
if (@$_GET['q'] == 'quiz' && @$_GET['step'] == 2 && isset($_GET['start']) && $_GET['start'] == "start" ) {
...
<h4 class="modal-title" style="font-family:'Times New Roman' "><span style="color:white">Organished by QUIZELLER Team</span></h4>
</div>
<div class="col-md-4 box">
<h4 class="modal-title" style="font-family:'Times New Roman' "><span style="color:white">ISE,MITM</span></h4></div>
<div class="col-md-4 box">
<h4 class="modal-title" style="font-family:'Times New Roman' "><span style="color:white">Copyright@2021-21</span></h4></div>
</body>
</html>
