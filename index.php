...
function validateForm() {
  ...
  if (rn.length !=10) {
    document.getElementById("errormsg").innerHTML="Incorrect USN. Please enter in the format (4MH19IS001)";
    return false;
  }
  /*if(rn.value == (mysqli_query($con, "SELECT * FROM user WHERE username = '". $_POST['rollno']."'");)){
            }
    else{
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="phno" name="phno" placeholder="Enter your mobile number" class="form-control input-md" type="real" value="<?php
if (isset($_GET['phno']))
{
echo $_GET['phno'];
}
...
<div class="row footer " style="background-color:rgb(18, 138, 171);">
<div class="col-md-2 box ">
<a href="#" data-toggle="modal" data-target="#login" style="color:lightyellow">Admin Login</a></div>
<div class="col-md-3 box">
<a  data-toggle="modal"  s style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">Organized by Quizeller Team<br></a>
</div>
<span class="col-md-3 box" style="color:lightyellow">ISE,MITM<br></span>
<span class="col-md-3 box" style="color:lightyellow">Copyright@2021-22<br></span>
<div class="col-md-2 box ">
